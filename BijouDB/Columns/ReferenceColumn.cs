...
{
    private readonly Func<IndexedColumn<R, D>> _sourceColumn;

    public ReferenceColumn(Func<IndexedColumn<R, D>> sourceColumn) => _sourceColumn = sourceColumn;
    ...
    public R[] Get(D value) => _sourceColumn().RecordsWithValue(value);
    ...
    public bool HasRecords(D value) => _sourceColumn().HasRecords(value);
}
