...
{
    public struct @tuple<T1, T2, T3, T4, T5, T6> : IDataType
        ...
        where T6 : IDataType, new()
    {
        ...
        public (T1, T2, T3, T4, T5, T6) _value;

        public @tuple((T1, T2, T3, T4, T5, T6) value) => _value = value;
        ...
        public static implicit operator (T1, T2, T3, T4, T5, T6)(@tuple<T1, T2, T3, T4, T5, T6> value) => value._value;
        public static implicit operator @tuple<T1, T2, T3, T4, T5, T6>((T1, T2, T3, T4, T5, T6) value) => new(value);
        ...
        public sealed class nullable : IDataType
        {
            ...
            public nullable((T1, T2, T3, T4, T5, T6)? value) => _value = value;
            ...
            public void Deserialize(Stream stream)
            {
                switch (stream.ReadByte())
                {
                    ...
                    default:
                        {
                            _value = (new T1(), new T2(), new T3(), new T4(), new T5(), new T6());
            ...
            public static implicit operator (T1, T2, T3, T4, T5, T6)?(nullable value) => value._value;
            public static implicit operator nullable((T1, T2, T3, T4, T5, T6)? value) => new(value);
        }
    }
}
