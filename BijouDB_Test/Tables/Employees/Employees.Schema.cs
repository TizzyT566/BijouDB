...
public partial class Employees : Table
{
    ...
    public static readonly IndexedColumn<Employees, @string> NameColumn; // Used to represent the entire column of this table
    ...
    public static readonly ReferencesColumn<Employees, Employees> EmployeeReferencesColumn; // Used to reference other records in other tables related to table (similar to foriegn keys)
    public Employees[] EmployeeReferences => EmployeeReferencesColumn.Get(this); // Access references a specific record

    private static readonly Func<Employees, bool>? _remove; // Remove operations are tailored to each table, and generated by the ColumnBuilder
    public bool Remove() => _remove!(this);

    private static readonly Func<dynamic[], bool>? _insert;
